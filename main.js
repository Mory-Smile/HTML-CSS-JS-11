...
let loadImage = () => {
  ...
  previewImg.addEventListener("load", () => {
    resetFilterBtn.click(); // clicking reset btn, so the filter value resets if the user select new image
...
let updateFilter = () => {
  ...
  let selectedFilter = document.querySelector(".filter .active"); // getting selected filter btn
...
let saveImage = () => {
  ...
  link.click(); // clicking <a> tag so the image is downloaded
};
